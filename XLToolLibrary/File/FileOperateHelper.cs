...
namespace XLToolLibrary.Utilities
{
    public class FileOperateHelper
    {
        ...
        protected void Write_Txt(string FileName, string Content, Encoding encoding=null)
        {
        ...
        /// <param name="encoding"></param>
        /// <returns></returns>
        protected string Read_Txt(string filename,Encoding encoding = null)
        {
        ...
        /// <param name="encoding"></param>
        /// <returns></returns>
        protected static Encoding GetEncoding(Encoding encoding)
        {
            if ( encoding == null )
        ...
        *****************************************/
        ...
        public static void WriteFile(string Path, string Strings,Encoding encoding=null)
        {
            Encoding code = GetEncoding( encoding );
