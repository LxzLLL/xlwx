...
namespace XLToolLibrary.Utilities
{
    /// <summary>
    /// 作者：Arvin
    /// 日期：2016/2/16 10:49:25
    /// 描述：Http帮助类
    /// </summary>
    #region HttpClient，作为客户端
    public class HttpHelper
    {
        ...
        private void SetCer(HttpItem item)
        {
            ...
            {
                //未设置证书路径，但设置全部信任，用于https
                if(item.IsTrustCertificate)
                {
                    ServicePointManager.ServerCertificateValidationCallback = new System.Net.Security.RemoteCertificateValidationCallback( CheckValidationResult );
                }
                //初始化对像，并设置请求的URL地址
    ...
    public class HttpItem
    {
        ...
        private bool _isTrustCertificate = false;
        /// <summary>
        /// 设置或获取证书全部信任，默认false
        /// </summary>
        public bool IsTrustCertificate
        {
            get { return _isTrustCertificate; }
            set { _isTrustCertificate = value; }
        }
    }
    /// <summary>
    /// Http返回参数类
...
#region HttpServer，作为服务端
    public class HttpServerHelper
    {
        ...
        public static void ResponseWrite(string strContent)
        {
